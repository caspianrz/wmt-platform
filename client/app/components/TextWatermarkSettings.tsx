...
export default function TextWatermarkSettings(props: WatermarkGenProps) {
	...
	const createFromText = () => {
		if (props == null || props.setWatermark == null) {
			return;
		}
	...
	return (
		<div>
			...
			<ImageCanvas imageData={props.watermark} />
		</div>
	);
}
